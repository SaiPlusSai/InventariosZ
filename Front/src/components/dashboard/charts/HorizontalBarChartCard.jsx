...
const HorizontalBarChartCard = ({ title, subtitle, data, dataKey = "value", nameKey = "name", color = "#10B981" }) => {
      ...
      <div className="flex-1 min-h-0">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart layout="vertical" data={data} margin={{ top: 10, right: 30, left: 10, bottom: 0 }}>
            ...
            <YAxis type="category" dataKey={nameKey} axisLine={false} tickLine={false} tick={{fill: '#6B7280', fontSize: 12}} width={80} />
            <Tooltip 
              cursor={{fill: '#F3F4F6'}} 
