  ...
  return (
    <>
      ...
      <div className={`
        ...
        md:relative md:inset-auto md:z-auto md:bg-gray-50/50 md:rounded-none md:shadow-none md:transform-none md:block md:transition-all md:origin-top md:overflow-hidden
        ${showFilters ? 'md:max-h-[1000px] md:opacity-100 md:border-t md:border-gray-100' : 'md:max-h-0 md:opacity-0'}
      `}>
