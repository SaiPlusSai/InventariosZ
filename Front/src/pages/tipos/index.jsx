      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 tracking-tight">
            {isPapeleraMode ? 'Tipos de Calzado (Papelera)' : 'Tipos de Calzado'}
          </h1>
          <p className="text-gray-500 mt-1">
            {isPapeleraMode ? 'Categorías inactivas' : 'Gestiona las categorías de calzado.'}
          </p>
        </div>
          ...
          {!isPapeleraMode && (
            <>
              ...
              <Button variant="primary" onClick={() => handleOpenModal()} className="flex-1 md:flex-none shadow-md shadow-primary-500/20">
                <Plus size={16} className="mr-2 inline"/> Nuevo Tipo
              </Button>
            </>
          )}
        </div>
